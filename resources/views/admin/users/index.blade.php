            ...
            <div class="row g-4 align-items-end">
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" id="search" name="search" value="{{ request('search') }}"
                        class="form-control form-control-sm" placeholder="Tìm kiếm theo tên hoặc email..."
                        aria-label="Tìm kiếm người dùng theo tên hoặc email">
                </div>

                <div class="col-12 col-md-3">
                    <label for="role" class="form-label fw-semibold mb-1">Vai trò</label>
                    <select id="role" name="role" class="form-select form-select-sm" aria-label="Chọn vai trò">
                        <option value="all" {{ (request('role') === null || request('role') === 'all') ? 'selected' : '' }}>Tất cả</option>
                ...
                <div class="col-12 col-md-3">
                    ...
                    <select id="status" name="status" class="form-select form-select-sm" aria-label="Chọn trạng thái">
                        <option value="all" {{ (request('status') === null || request('status') === 'all') ? 'selected' : '' }}>Tất cả</option>
                ...
                <div class="col-12 col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="btn btn-sm btn-outline-secondary flex-grow-1" aria-label="Đặt lại bộ lọc">
