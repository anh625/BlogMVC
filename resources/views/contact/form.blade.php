                    ...
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                <input required name="contact_name" type="text" class="form-control" placeholder="Your Name">
                            </div>
                            <div class="col-6 mb-3">
                                <input required name="contact_phone" type="number" class="form-control" placeholder="Your Phone">
                            </div>
